	...
	switch(_text_id){
		...
		case "event_17":
			...
			case "event_17_3":
				...
				break;
			case "event_17_4":
				Obj_set_remove_event.event_id="event_1_3";
		...
		case "event_29":
			...
			m_set_text("コロシアムじゃな\nリアン　レアン　案内してやりなさい","ジョージ","new_kohaku_confused","","2");
		...
		case "event_32_boss_1":
			...
			m_set_text("私の剣技を見切れるかな？","ブライド","kohaku_odoroki","","2");
		...
		case "event_32_boss_2":
			...
			m_set_text("え？大丈夫なの？","コハク","kohaku_gimon","eltia_futeki","1");
			m_set_text("大丈夫です　少し私の力をお貸しするだけですから","エルティア","kohaku_gimon","eltia_futeki","2");
