...
function scr_game_text(_text_id,_system_text){
	...
	switch(_text_id){
		...
		case "event 1":		
			...
			break;
			case "talk":
				set_text("状況がわからないようですね","声の主","no","eltia");
				set_text("それでは話したいことはありますが\n先に操作方法から教えましょうか","声の主","no","eltia");
				set_text("まずは移動からですね","声の主","no","eltia");
				set_text("進みたい方向を十字キーで押してみてください\nそうするとその方向に進みますよ","声の主","no","eltia");
				break;
		case "event 2":
			set_text("上出来ですね","声の主","no","eltia_ki");
			set_text("それでは次は身の守り方を知りましょうか","声の主","no","eltia");
			set_text("移動方法は変わりませんが攻撃が出来ます\nZキーで攻撃しますよ","声の主","no","eltia");
			set_text("貴方の体力は下に表示されています\nこれがゼロになると負けてしまいますのでお気をつけて","声の主","no","eltia");
			set_text("相手の攻撃に当たらないように気を付けてくださいね","声の主","no","eltia");
			set_text("頑張ってください","声の主","no","eltia");
			break;
		case "event 2_1":
			set_text("さすがです","声の主","no","eltia_ki");
			set_text("どうですか？記憶の混乱は落ち着きましたか？","声の主","no","eltia_gimon");
			scr_option("名前以外思い出せない","event_2_1_1");
			break;
			case "event_2_1_1":
				set_text("おや、それは困りましたね","声の主","no","eltia_gimon");
				set_text("それでは辺りを調べてみましょう","声の主","no","eltia_sasayaki");
		case "event 3":
			set_text("だいぶ暗いですね","声の主","no","eltia_sasayaki");
			set_text("しかも今にも崩れそうです","声の主","no","eltia_sasayaki");
			set_text("慎重に進みましょうか","声の主","no","eltia_sasayaki");
			break;
		case "event 4":
			set_text("広い場所に出ましたね","声の主","no","eltia_sasayaki");
			set_text("でも気を付けてください　\n何が起こるかわかりませんから","声の主","no","eltia");
			break;
		case "event 5":
			set_text("そういえば自己紹介がまだでしたね","声の主","no","eltia");
			set_text("私はエルティア\n訳あってあなたと喋ることができています","エルティア","no","eltia_ki");
			scr_option("私の名前は…","system_talk1");
			break;
			case "system_talk1":
				set_text("あなたの名前はもちろん知っていますよ","エルティア","no","eltia_futeki");
				set_text("よろしくお願いしますね\nニマ　コハクさん","エルティア","no","eltia_futeki");
				set_text("(なんで知ってるんだろう？)","コハク","kohaku","no");
				break;
		case "event 6":
			set_text("おや、ここだけ明るいですね","エルティア","no","eltia_gimon");
			set_text("これは…？","コハク","kohaku","eltia_gimon");
			set_text("コハクは床に落ちているペンダントを拾った。","","no","no");
			set_text("するとコハクの中に突然記憶があふれてきた","","no","no");
			set_text("崩壊しかけた世界で相対する光景が見えた","","kohaku_ai","no");
			set_text("これはいったい…？","コハク","kohaku_ai","no");
			set_text("それを首にかけた途端に目の前が白く覆われた!","","no","no");
			set_text("え？なに！？","コハク","gate_odoroki","no");
			break;
			//town
		case "event 7":
			set_text("え、何処ここ？","コハク","gate_konwaku_2","no");
			set_text("エルティア？","コハク","gate_konwaku_2","no");
			set_text("エルティアからの反応はない","","gate_konwaku_2","no");
			set_text("もう…","","gate_futekusare","no");
			set_text("とりあえず聞き込みね","コハク","gate_interested","no");
			break;
		case "event 8":
			set_text("よかった…街から出れたみたい","コハク","gate_tsuujou","no");
			set_text("他の街に行ってみましょう","コハク","gate_tsuujou","no");
			break;
		case "event 9":
			set_text("道が封鎖されている","コハク","","no");
			set_text("うそでしょ…","コハク","gate_kyoufu_2","no");
			set_text("どこかに通れる道はないかな？","コハク","gate_ai","no");
			break;
			global.talkwall="0";
		case "event 10":
		...
		case "event 14":
			...
			set_text("ここは！？","コハク","gate_odoroki","guruka_magao");
			set_text("バシ帝国の地下牢だぜ","獣の少女","gate_konwaku_1","guruka_magao");
			set_text("あんたは何をしてここに連れてこられたんだ？","獣の少女","gate_konwaku_1","guruka_magao");
			...
			case "event_g":
				...
				break;
		case "event_14_2":
			set_text("俺か？俺はグルカだ","獣の少女","gate_tsuujou","guruka_emi");
			set_text("しがない傭兵をしている\nよろしくな　え～っと…","グルカ","gate_tsuujou","guruka_emi");
			set_text("ニマ　コハクです！よろしく！","コハク","gate_ki","guruka_emi");
			break;
		case "event 15":
			set_text("なぁ、ここから出たいと思わないか","グルカ","no","guruka_purasu");
			scr_option("もちろん","event_15_1");
			scr_option("ここでもいいかなぁ…","event_15_2");
			break;
			case "event_15_1":
				set_text("それなら話は早い","グルカ","no","guruka_purasu");
				set_text("後ろの壁を掘っておいてある","グルカ","no","guruka_purasu");
				set_text("新しくあんたが来たってことは手続きやらなんやらでバタバタしてるからな","グルカ","no","guruka_purasu");
				set_text("この隙に脱出するぞ","グルカ","no","guruka");
				break;
			case "event_15_2":
			Player.status_g+=1;;
			Player.set_textoption+=1;
				set_text("…冗談だろ？","グルカ","no","guruka_odoroki");
				set_text("とりあえずここから脱出する\n付いてこい","グルカ","no","guruka_magao");
				set_text("付いていきましょう\nあなたの役に立つと思いますよ","エルティア","no","guruka_magao");
				break;		
		case "event 16":
			set_text("ところでグルカってさ","コハク","gate_interested","no");
			set_text("その服装は趣味なの？","コハク","gate_interested","no");
			set_text("俺の基本行動は特殊でな　そのための服さ","グルカ","gate_interested","guruka_purasu");
			set_text("なるほど","コハク","gate_ki","guruka_purasu");
			break;
		case "event 17":
			set_text("なんだここは","グルカ","no","guruka_magao");
			set_text("何かのための広場でしょうかね？","エルティア","no","guruka_magao");
			set_text("王国のネズミがコソコソ何をしてるんだ？","？？？","no","isaku_gimon");
			set_text("おいおい勘弁してくれや…","グルカ","no","guruka_odoroki");
			set_text("なんでお前がここにいるんだ…","グルカ","no","guruka_odoroki");
			set_text("口を慎め猫男","？？？","guruka_odoroki","isaku_do");
			scr_option("猫男！？","event_17_2");
			scr_option("貴方は誰なの？","event_17_1");
			break;
			case "event_17_1":
				set_text("こいつは帝国７災獣の内の一人…\n怠惰担当の'イサク'だ","グルカ","guruka_magao","isaku");
				set_text("気をつけろ　本気を出せばチリどころじゃすまないぞ","グルカ","guruka_magao","isaku");
				set_text("シャーシャーやかましいな\nそろそろ消し飛ばすか","イサク","guruka_magao","isaku_warai");
				break;
			case "event_17_2":
				Player.set_textoption+=1;
				set_text("そんなの今はどうでもいいだろ！","グルカ","guruka_odoroki","isaku");
				set_text("よりにもよって'イサク'だ…","グルカ","guruka_odoroki","isaku_emi");
				set_text("さて、フェリスの為の研究材料にしてやろうか","イサク","guruka_odoroki","isaku_emi");
				break;
			
		case "event 18":
			set_text("これは…空間転送のための陣ですね","エルティア","no","eltia_gimon");
			set_text("しかも使い切りのようです","エルティア","no","eltia_gimon");
			set_text("何でこんなところにこいつがあるんだ？","グルカ","guruka_purasu","eltia_gimon");
			set_text("まぁいい\n追手が来る前に行くぞ","グルカ","guruka_magao","eltia_gimon");
			break;
		case "event 19":
			set_text("よし、上手くいった","グルカ","no","guruka_emi");
			set_text("おぬしら何者じゃ！\n突然光ったと思ったら現れおって！","国王","no","no");
			set_text("お…？おぬしグルカか","国王","no","no");
			set_text("国王陛下\n帝国側からただいま帰還いたしました","グルカ","no","guruka_magao");
			set_text("また、帝国７災獣怠惰と交戦、再起不能といたしました","グルカ","no","guruka_magao");
			set_text("なるほど\nして、この者は？","国王","no","guruka_magao");
			set_text("彼女はコハク\n怠惰撃退の功労者でございます","グルカ","no","guruka_magao");
			set_text("ふむ\nその功績をたたえて宝物庫から一つ好きなものを授けよう","国王","no","guruka_magao");
			set_text("受け取っておきましょう\nそれにこれから先役立つものがあるかもしれないですし","エルティア","no","eltia_raku");
			scr_option("エルティアがそういうなら…","option_3");
			scr_option("光栄であります","option_3");
			break;
				case "option_3":
				set_text("本来は正式にやるのであるがな…","国王","no","no");
				set_text("すまないな","国王","no","no");
				global.talkwall="1";
				break;
		case "event 20":
			set_text("これは…ブローチ？","コハク","gate_konwaku_1","no");
			set_text("だいぶ古い感じがするけど…","コハク","gate_konwaku_1","no");
			set_text("っ！？","コハク","gate_kizetsu_1","no");
			set_text("ブローチはコハクと同調しだした","","no","no");
			set_text("頭にぼんやりと二人の人物が浮かんできた","","no","no");
			set_text("これは…私の記憶…？","コハク","gate_ai","no");
			set_text("おや、なにか起こりました？","エルティア","gate_ai","eltia_gimon");
			set_text("エルティア見れた？","コハク","gate_ai","eltia_gimon");
			set_text("いえ、私のほうでは何も…","エルティア","gate_ai","eltia_gimon");
			set_text("(ということは私だけ…？でもなんで…)","コハク","gate_ai","no");
			set_text("(謎は残るけどとりあえず外に出よう)","コハク","gate_ai","no");
			global.talkwall="2";
			break;
		
		case "event 21":
			set_text("…なぁ","グルカ","gate_konwaku_2","guruka_purasu");
			set_text("あんたこれからどうするんだ？","グルカ","gate_konwaku_2","guruka_purasu");
			set_text("どうするってそりゃ","コハク","gate_konwaku_2","guruka_purasu");
			...
			break;
			case "event_21_1":
				set_text("そうか…","グルカ","gate_raku","guruka_purasu");
				set_text("止めはしないが戦闘慣れしてないだろ","グルカ","gate_raku","guruka_purasu");
				set_text("少しだけ慣れるようにしてやるよ","コハク","gate_raku","guruka_purasu");
				break;
			case "event_21_2":
				set_text("なら俺と一緒に来ないか？","グルカ","gate_odoroki","guruka_emi");
				set_text("即席であのイサクを退けられたんだ\n絶対いいバディになれるさ","グルカ","gate_odoroki","guruka_emi");
				set_text("どうしよう…","コハク","gate_konwaku_1","guruka_emi");
				set_text("断りましょう","エルティア","gate_odoroki","eltia_raku");
				set_text("エルティア？どうして？","コハク","gate_ai","eltia_raku");
				set_text("確かにメリットはあります　しかしデメリットが未知数です","コハク","gate_ai","eltia_sasayaki");
				set_text("それは今聞けばいいのでは？","コハク","gate_konwaku_1","eltia_sasayaki");
				set_text("それに言ってませんでしたがあの神殿で拾ったとき記憶が流れてきたのでしょう？","エルティア","gate_konwaku_1","eltia_gimon");
				set_text("貴方の記憶と関係があるかもしれませんし知る必要があると思います","エルティア","gate_konwaku_1","eltia_gimon");
				set_text("エルティアの言うことは一理ある","","no","no");
				set_text("それならば…","","no","no");
				set_text("申し訳ないけど誘いは辞退させてもらうよ","コハク","gate_ai","guruka_purasu");
				set_text("そうか…","グルカ","gate_konwaku_1","guruka_purasu");
				set_text("なら止めねぇが…\nもう一度あの攻撃を見せてくれ","グルカ","gate_konwaku_2","guruka_purasu");
				set_text("あれはどちらかというと舞のための動きに見えた","グルカ","gate_konwaku_2","guruka_purasu");
				set_text("あれは今後参考になるかもしれねぇ","グルカ","gate_interested","guruka_purasu");
				set_text("…わかった\n手加減はしないよ！","コハク","gate_raku","guruka_emi");
				set_text("もちろんこっちこそな！","グルカ","gate_raku","guruka_emi");
				break;
			case "event_21_3":
				Player.set_textoption+=1;
				set_text("おいおいいきなり告白とかシビれるなぁ","グルカ","no","guruka_emi");
				set_text("だが悪いな　俺は…","グルカ","no","guruka_purasu");
				set_text("うぉ！？なにすんだ！","グルカ","no","guruka_odoroki");
				set_text("断られちゃったからねぇ…\nならやることは一つでしょう？","コハク","gate_interested","guruka_odoroki");
				set_text("おいおいいきなりどうしたんだ？","グルカ","gate_interested","guruka_odoroki");
				set_text("コハクは問答無用で攻撃を仕掛ける！","","no","no");
				break;
		
		case "event 22":
		if(Player.set_textoption>=4&&Player.status_g>=1)
		{
			set_text("ありゃ　死んじゃった？","コハク","gate_interested","yarare_nirami");
			scr_option("生きてる～？","event_22_1");
			break;
		}
			set_text("…ありがとうな","グルカ","no","yarare_understand");
			set_text("グルカはこの後どうするの？","グルカ","gate_konwaku_2","yarare_understand");
			set_text("俺は傭兵業を続けるさ","グルカ","gate_interested","yarare_nigawarai");
			set_text("安心しろ　今生の別れじゃねぇんだ","グルカ","gate_interested","yarare_ki");
			set_text("また会うときはもっと強くなってやる\nそして次は勝ってやるかなら","グルカ","gate_raku","guruka_emi");
			set_text("うん！またね！","コハク","gate_raku","guruka_usiro");
			break;
		case "event_22_1":
			set_text("チッやりやがったな…","グルカ","no","yarare_do");
			set_text("俺には他にもできることがあるんだぜ…","グルカ","no","yarare_do");
			set_text("地獄に落ちやがれ…クソッタレ…","グルカ","no","yarare_do");
			break;
		case "event 23":
			set_text("さて、それでは行きましょうか","エルティア","no","eltia_sasayaki");
			set_text("門を起動するには特定の場所に行く必要があります","エルティア","no","eltia_sasayaki");
			set_text("城を出てそのまま南下していけば門の起動場所に着くそうですよ","エルティア","no","eltia_sasayaki");
			break;
		case "event 24":
			set_text("コハクは首にかけている簡易門(インスタントゲート)を起動した","","","");
			set_text("指定場所は","コハク","gate_interested","no");
