...
function m_scr_game_text(_text_id,_system_text){
	...
	switch(_text_id){
		...
		case "event_26":			
			...
			case "event_26_1":
			m_set_text("誰？","コハク","","");
			m_set_text("リアンだよ～","リアン","","");
			m_set_text("レアンだねぇ","レアン","","");
			m_set_text("おねーさんは？","リアン","","");
			m_set_text("私はコハクよ","コハク","","");
			m_set_text("よろしくね　リアン　レアン","コハク","","");
			m_set_text("ところで2人はここがどこかわかる？","コハク","","");
			m_set_text("ここは地図に載ってない島","レアン","","");
			m_set_text("フォートアイランドだよ","リアン","","");
			m_set_text("フォートアイランド？","コハク","","");
			m_set_text("ここには移動のための施設がないから\n基本来ることも出ることも出来ないんだよねぇ","レアン","","");
			m_set_text("じゃぁ私はどうやって…？","コハク","","");
			m_set_text("多分天与の影響だと思う","リアン","","");
			m_set_text("天与？","コハク","","");
			m_set_text("おねーさんが首にかけてるそれだねぇ","レアン","","");
			m_set_text("宝物のこと？","コハク","","");
			m_set_text("そー　ここでは天与っていうの","リアン","","");
			m_set_text("それが壊れてここに着いちゃったみたいだねぇ","レアン","","");
			m_set_text("じゃぁ他の島に行けないってこと…？","コハク","","");
			m_set_text("大丈夫　この島には宝物の修理屋がいるから","リアン","","");
			m_set_text("そんな人がいるの？","コハク","","");
			m_set_text("こっちだよ　付いてきて！","リアン","","");
			Obj_anyevent.event_id="event_2";
			Obj_anyevent.set_text_move=2;
			break;
		case "event_27":
			m_set_text("ここだよここ","レアン","","");
			m_set_text("ここ？","コハク","","");
			m_set_text("ここが宝物の修理をやってるジョー爺のお店だねぇ","レアン","","");
			m_set_text("ほら、入って入って！","リアン","","");
			break;
			
		case "event_28":
			m_set_text("ジョー爺！やっほー！","リアン","","");
			m_set_text("大人しくせんかい！やかましい！","？？？","","");
			m_set_text("でも今日はとっておきがあるから","レアン","","");
			m_set_text("全く…都合がいいこと言いおって…","ジョージ","","");
			m_set_text("お邪魔します…","コハク","","");
			Obj_anyevent.set_text_move=1;
			Obj_anyevent.text_id1="event_28_1";
			break;
			case "event_28_1":
			m_set_text("おぉ、お客人か儂は何でも修理する修理屋のジョージじゃ","ジョージ","","");
			m_set_text("ニマ・コハクです\n実は宝物が壊れちゃったらしくて","コハク","","");
			m_set_text("これなんですけど…","コハク","","");
			m_set_text("ふむ、量産型の天与か　この場で修理はできるが値段は張るぞ","ジョージ","","");
			m_set_text("えぇ…エルティア　いまぐらい持ってるっけ？","コハク","","");
			m_set_text("丁度3日宿に泊まれるぐらいですね","エルティア","","");
			m_set_text("えーっと…どのくらいですか？","コハク","","");
			m_set_text("大体680万リダぐらいだな","ジョージ","","");
			m_set_text("どうしよ…そんな持ち合わせは…","コハク","","");
			m_set_text("ん～？ないなら稼げばいいじゃん！隣で丁度大会やってるよ","リアン","","");
			m_set_text("そーそ、おねーさん強そうだし","レアン","","");
			m_set_text("ふむ、少し足りんが優勝してくるならそれで免除してやろう","ジョージ","","");
			m_set_text("なるほど、いい機会ですし参加してきませんか？","エルティア","","");
			m_scr_option("参加する！","event_29");
			m_scr_option("どうしよう…","option_5_no");
			break;
			case "option_5_no":
				m_set_text("これに参加しないと簡易門直せませんよ？","エルティア","","");
				m_scr_option("じゃぁ参加する！","event_29");
				m_scr_option("でも…","option_5_no");
				break;
		
		case "event_29":
			m_set_text("おねーさんでるの！？じゃぁ私も出る！","リアン","","");
			m_set_text("だめだねぇ僕たち殿堂入りで参加禁止されてるから","レアン","","");
			m_set_text("えー！私もでーたーいー！","リアン","","");
			m_set_text("受付ではじかれちゃうねぇ","レアン","","");
			m_set_text("ところで…受付はどこにあるの？","コハク","","");
			m_set_text("コロシアムじゃな\nリアン　レアン　案内してやりなさい","ジョージ","","");
			m_set_text("はーい","リアン・レアン","","");
			Obj_anyevent.event_id="event_4";
			Obj_anyevent.set_text_move=2;
			Obj_Player.set_remove_number=1;
			break;
		case "event_29_1":
			m_set_text("おねーさんこっちこっち！","リアン","","");
			m_set_text("早くしないと受付終わっちゃうからねぇ","レアン","","");
			m_set_text("2人とも早いなぁ","コハク","","");
			m_wall_event(Obj_wall_event.wall_id);
		...
		case "event_30":
			...
			case "set_1":
				...
				m_set_text("それじゃ僕たちは観客席で見てるから","レアン","","");
				m_set_text("おねーさんがんばってねー！","リアン","","");
				m_wall_event(Obj_wall_event.wall_id);
				break;
		
		case "event_31":
			m_set_text("まもなく第4回メモリアルマッチを開催いたします。\n選手の皆様はスタジアムの方に移動願います。","アナウンス","","");
			m_set_text("さて、行きましょうか","エルティア","","");
			break;
		...
		case "event_32":
			...
			m_set_text("なるほど、要するに勝てば良いってことね","コハク","","");
			m_set_text("実況はこの俺！D.C.ブライドが行わせていただく！","ブライド","","");
			Obj_anyevent.set_text_move=1;
			Obj_anyevent.text_id1="event_32_1";
			break;
			case "event_32_1":
			m_set_text("それじゃ試合開始！！","ブライド","","");
			Obj_anyevent.text_id1="event_32_boss_1";
			break;
		case "event_32_boss_1":
			m_set_text("見慣れない方がいますね　私が手合わせしましょうか","ドリーメイス","","");
			m_set_text("これって申告制だったっけ？","コハク","","");
			m_set_text("これが私の戦闘スタイルなので","ドリーメイス","","");
			m_set_text("おっと！速閃ドリーメイスが切り込んでいったぁ！","ブライド","","");
			m_set_text("私の剣技を見切れるかな？","ブライド","","");
			Obj_anyevent.text_id1="event_32_boss_2";
			break;
		case "event_32_boss_2":
			m_set_text("いきなり波乱の展開！優勝候補のドリーメイスが切り伏せられてしまったぁ！\nスピード勝負を制したのは今大会初出場の新人！","ブライド","","");
			m_set_text("はぁ…はぁ…すっごい速かった…","コハク","","");
			m_set_text("お疲れですか？","エルティア","","");
			m_set_text("あ、エルティア？ちょっと体力が持たなくて…","コハク","","");
			m_set_text("では少し目を閉じてみてください","エルティア","","");
			m_set_text("え？大丈夫なの？","コハク","","");
			m_set_text("大丈夫です　少し私の力をお貸しするだけですから","エルティア","","");
			m_set_text("じゃぁ少しだけ…","コハク","","");
			m_set_text("おや？新人が動かなくなったぞ？","ブライド","","");
			m_set_text("さて、何としても優勝されなくては困るのでね\nご協力お願いしますよ","エルティア","","");
			Obj_anyevent.text_id1="event_32_boss_3";
			break;
		case "event_32_boss_3":
			m_set_text("そろそろですかね","エルティア","","");
			m_set_text("ッ！","コハク","","");
			m_set_text("エルティアありがとう","コハク","","");
			m_set_text("さて、いよいよ終盤戦！ここまで残ったのは破壊僧ブロットと期待の新人コハクです！\nどちらが優勝するのか我々も目が離せません！","ブライド","","");
			m_set_text("ふははははははは！！\nよくここまで残ったと褒めてやりたいところだ！","ブロット","","");
			m_set_text("だがこの俺を超えることはできぬぅ！","ブロット","","");
			m_set_text("剛力ブロットはこの天与で作られた完全防御の壁を唯一破壊した人物だ！\n彼の一撃に耐えることはできるのか！？","ブライド","","");
			m_set_text("出来るだけ当たらないようにしないと…","コハク","","");
			m_set_text("生きて帰れるといいなぁ？","ブロット","","");
			Obj_anyevent.text_id1="event_33";
			break;
			
		case "event_33":
			m_set_text("試合終了！優勝はニマ・コハクゥゥゥゥゥゥ","ブライド","","");
			m_set_text("これにて第4回メモリアルマッチを終了する！\n実況はこの俺D.C.ブライドがお送りした！","ブライド","","");
			m_set_text("(早く戻ろう)","コハク","","");
			Obj_anyevent.set_text_move=0;
			Obj_Player.set_remove_number=1;
			break;
			
		case "event_34":
			m_set_text("優勝おめでとうございます　賞金600万リダでございます。","受付","","");
			m_set_text("600万リダを手に入れた","","","");
			m_set_text("おねーさーん！","リアン","","");
			Obj_set_remove_event.set_text_move=2;
			break;
			case "event_34_1":
			m_set_text("おめでとー","レアン","","");
			m_set_text("2人ともありがとう！","コハク","","");
			m_set_text("それじゃ賞金も受け取ったし行こっか","コハク","","");
			m_set_text("おー！","リアン・レアン","","");
			Obj_set_remove_event.set_text_move=2;
			break;
		...
		case "event_35":
			...
			m_set_text("きさま…を…　…っ…！","？？？","","");
			m_set_text("おや、………","エルティア？","","");
			m_set_text("これは…？えるてぃあ…？","コハク","","");
			m_set_text("おねーさん！","リアン","","");
			m_set_text("ハッ！","コハク","","");
			m_set_text("どうした？急にボーッとしおって","ジョージ","","");
			m_set_text("いえ、なにも…","コハク","","");
			m_set_text("？まぁよい　簡易門は来た時と同じ場所で使用せい","ジョージ","","");
			m_set_text("分かった！ジョージおじいさんありがとう！","コハク","","");
			m_set_text("おう、気を付けてな","ジョージ","","");
			Obj_set_remove_event.set_text_move=0;
			break;
			
		case "event_36":
			m_set_text("それじゃ行こっか","コハク","","");
			m_set_text("おねーさん…","リアン","","");
			Obj_set_remove_event.event_id="event_9";
			Obj_set_remove_event.set_text_move=2;
			break;
			case "event_36_1":
			m_set_text("大丈夫　また会えるよ","コハク","","");
			m_set_text("ほんと？","リアン","","");
			m_set_text("うん、ほんと！","コハク","","");
			m_set_text("わかった！","リアン","","");
			m_set_text("それじゃ、行くね","コハク","","");
			m_set_text("簡易門起動","コハク","","");
			m_set_text("辺りが白く輝く…","","","");
			Obj_set_remove_event.text_id1="event_36_2";
			break;
			case "event_36_2":
				Obj_Player.visible=false;
				m_set_text("行っちゃったねぇ","レアン","","");
				m_set_text("付いていきたかったなぁ…","リアン","","");
				m_set_text("しょうがないよ　まだ終わってないんだから","レアン","","");
				m_set_text("しょうがないねぇ","リアン","","");
				m_set_text("腫恨髑髏は常に見ている","リアン・レアン","","");
