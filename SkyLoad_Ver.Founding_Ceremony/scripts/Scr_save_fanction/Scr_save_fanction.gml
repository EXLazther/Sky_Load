...
function m_save_room()
{
    ...
    if room == Room_start {global.levelData.level_1= _roomStruct;};
    if room == Room_test_rm {global.levelData.level_2= _roomStruct;};
    if room == Room_castle1 {global.levelData.level_3= _roomStruct;};
    /* ＃obj_saveload＃に部屋番号の追加をする
    同ステージの遷移なら2-1、2-2みたいにする？*/
}

function m_load_room(){
    var _roomStruct=0;
