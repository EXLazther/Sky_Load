...
part_type_size(explosion_particle, 0, 1, 0.01, 0);  // 初期サイズと最終サイズ
part_type_scale(explosion_particle, 1, 1);  // x方向とy方向のスケーリング
part_type_life(explosion_particle, 120, 180);  // パーティクルの寿命（30~60フレーム）
part_type_speed(explosion_particle, 1, 12, 0, 0);  // パーティクルの速度範囲
part_type_direction(explosion_particle, 0, 360, 0, 0);  // 全方向にランダムで飛ぶ
part_type_color3(explosion_particle, c_purple, c_aqua, c_aqua );  // カラーのグラデーション
...
particle = 0;
ObjBattleManager.finished_count = ObjBattleManager.current_frame;