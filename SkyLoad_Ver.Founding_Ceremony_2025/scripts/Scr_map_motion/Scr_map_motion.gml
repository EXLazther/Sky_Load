...
function map_objmove_setevent(_event_id)
{
	...
	switch(_event_id)
	{
		...
		case "event_1_3":
			...
			Obj_buttle_aftertalk.text_id1="event_17_5";
			Obj_buttle_aftertalk.set_text_move=1;
			break;
		case "event_1_4":
		...
		//2章
		case "event_1":
		var _objrian=instance_create_layer(629,-60,"Instances",Obj_rian);
		var _objrean=instance_create_layer(710,-60,"Instances",Obj_rean);
			_objrean.face=DOWN
			_objrian.face=DOWN
		...
		case"event_5_1":
			map_objmove_interpolation(Obj_Player.x,40,Obj_Player.x,Obj_Player.y-60,60,0,Obj_story_symbol);
			Obj_battleevent.set_text_move=1;
		break;
		case "event_6":
		...
		case "event_9":
			var _objrian1=instance_create_layer(Obj_Player.x+40,0,"Instances",Obj_rian);
			var _objrean1=instance_create_layer(Obj_Player.x-40,0,"Instances",Obj_rean);
